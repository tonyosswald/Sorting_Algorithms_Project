...
public class Hash3 extends BaseList {
	...
	int hash(String word) {
		//hash 3, hashes unique values for same-lettered words like (was and saw)
		
		int hash = 0;
		for (int i = 0; i < word.length(); i++) hash = (hash * 15) + word.charAt(i);
		return hash & 255;
	}
